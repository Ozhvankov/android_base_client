...
public class AdapterPallets extends RecyclerView.Adapter<AdapterPallets.TypeTransportViewHolder>{
    ...
    public AdapterPallets(Context context, ArrayList<ItemModel> myDataset) {
        mContext = context;
