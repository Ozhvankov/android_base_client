        ...
        mDataRepo = new DataRepo.getData(new DataRepo.onDataListener() {
            ...
            public void returnData(String data) {
                ...
                try {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(RefillActivity.this,
    ...
    void saveTask(String cellId, String lpnId) {
        mDataRepo = new DataRepo.getData(new DataRepo.onDataListener() {
            ...
            public void returnData(String data) {
                ...
                Toast.makeText(RefillActivity.this, data, Toast.LENGTH_SHORT).show();
            }
        });
        mDataRepo.saveTask(mId, "1", cellId, lpnId);
        mDataRepo.start();
    }
}
